...
public class SignInDialogActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.google_sign_in_button_sign_in).setOnClickListener(this);
        findViewById(R.id.regular_sign_in_button).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.google_sign_in_button_sign_in:
                signInViaGoogle();
                break;
            case R.id.regular_sign_in_button:
                signInRegularly();
                break;
        }
    }
    ...
    private void signIn() {
        ...
        restApi.signIn(username, password, new Callback<Response>() {
            @Override
